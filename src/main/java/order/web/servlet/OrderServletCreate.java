...
public class OrderServletCreate extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		form.setSales_id(Integer.valueOf(info.get(1)));
		form.setUser_id(Integer.valueOf(info.get(2)));
		try {
			form.setOrder_date(new SimpleDateFormat("dd/MM/yyyy").parse(info.get(3)));
